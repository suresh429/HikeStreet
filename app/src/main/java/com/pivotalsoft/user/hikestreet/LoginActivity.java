...
public class LoginActivity extends Activity implements
    ...
    private LinearLayout phoneLayout,verficationLayout;
    ProgressBar progressBar;
    String Role,role,status,userid,mobileno,usercode,lastlogintime,firebasekey;
    String message,fcmtkn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verficationLayout = (LinearLayout) findViewById(R.id.verificationLayout);
    ...
    private void userdata(){
        ...
        final String URL = Constants.VERIFY_USER_URL+mPhoneNumberField.getText().toString();
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if ("success".equals(message)){
                        ...
                        if (Role.equals(role) && role.equals(Role)) {

                            if (status.equals("Suspend")){

                                Toast.makeText(LoginActivity.this, "Your Account has been Suspended. please contact Admin!", Toast.LENGTH_LONG).show();
                                ...
                                verficationLayout.setVisibility(View.VISIBLE);
                                startPhoneNumberVerification(mPhoneNumberField.getText().toString());

                                SharedPreferences pref = getSharedPreferences("MyPref",  Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = pref.edit();
                                editor.putString("mobileno", mobileno);  // Saving string
                                editor.putString("userid", userid);  // Saving string
                                editor.putString("role", role);  // Saving string
                                Log.e("Role123",""+role);
                                editor.putString("status", status);  // Saving string
                                editor.putString("usercode", usercode);  // Saving string
                                editor.putString("firebaskey", firebasekey);  // Saving string
                            ...
                            Toast.makeText(LoginActivity.this, "You have signed up as a "+role+". Hence You cannot Login as a "+Role, Toast.LENGTH_LONG).show();
                        }
    ...
    private void addUser(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.RIGISTER_URL,
            ...
            protected Map<String,String> getParams() throws AuthFailureError {
                ...
                params.put("mobileno",mPhoneNumberField.getText().toString());
                params.put("role",Role);
                params.put("status", "Active");
                params.put("lastlogintime",formattedDate);
                params.put("usercode","0");
                params.put("firebasekey",fcmtkn);

                Log.e("RESPONSE_Parasms: ",""+Role+"\n"+formattedDate+"\n"+mPhoneNumberField.getText().toString());
                return params;
            }
   ...
   // update user key
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent pivotal = new Intent(LoginActivity.this, WelcomeActivity.class);
        pivotal.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(pivotal);
    }
}