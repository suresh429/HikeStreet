...
import com.pivotalsoft.user.hikestreet.EditEducationActivity;
...
public class EducationAdapter extends RecyclerView.Adapter<EducationAdapter.MyViewHolder> {
    ...
    public EducationAdapter(Context mContext, List<EducationItem> coursesItemList) {
    ...
    public void onBindViewHolder(final EducationAdapter.MyViewHolder holder, final int position) {
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EducationItem educationItem=coursesItemList.get(position);
                ...
                details.putExtra("degreename",educationItem.getDegree());
                details.putExtra("collegename",educationItem.getSchoolcollege());
                details.putExtra("startyear",educationItem.getStartyear());
                details.putExtra("endyear",educationItem.getEndyear());
                details.putExtra("educationid",educationItem.getEducationid());
