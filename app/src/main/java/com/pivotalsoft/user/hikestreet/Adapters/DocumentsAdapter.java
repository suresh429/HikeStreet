...
import com.pivotalsoft.user.hikestreet.EditDocumentActivity;
...
public class DocumentsAdapter extends RecyclerView.Adapter<DocumentsAdapter.MyViewHolder> {
    ...
    public DocumentsAdapter(Context mContext, List<DocumentsItem> coursesItemList) {
       ...
       // holder.txtCompany.setText(album.getCompany());
        ...
        holder.parentLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DocumentsItem documentsItem =coursesItemList.get(position);
                ...
                details.putExtra("documentid",documentsItem.getDocumentid());
                details.putExtra("documentno",documentsItem.getDocumentno());
                details.putExtra("documenttype",documentsItem.getDocumenttype());
                details.putExtra("documenturl",documentsItem.getDocumenturl());
