...
public class AddEducationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveDate(){
        ...
        if (!degreeName.isEmpty() && !endYear.isEmpty()  && !startYear.isEmpty() && !collageName.isEmpty() ) {
    ...
    private void addAdds(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constants.ADD_EDUCATION_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent pivotal = new Intent(AddEducationActivity.this, ProfileActivity.class);
                        pivotal.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(pivotal);
                        Toast.makeText(AddEducationActivity.this,"Education Added Successfully",Toast.LENGTH_LONG).show();
                    }
                },
