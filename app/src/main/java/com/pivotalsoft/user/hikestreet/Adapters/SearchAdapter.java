...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView txtFulltime,txtDays, txtTitle,txtDescription,txtCity,txtAmount;
        ...
        public MyViewHolder(View view) {
            ...
            String usercode =sp.getString("usercode","0");
    ...
    public SearchAdapter(Context mContext, List<SearchItem> coursesItemList) {
